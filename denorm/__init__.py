...
if hasattr(settings, "DENORM_FLUSH_AFTER_REQUEST"):
    ...
    warnings.warn(
        "The DENORM_FLUSH_AFTER_REQUEST will be deprecated in favor of the new DenormMiddleware",
        DeprecationWarning,
    )

if (
    hasattr(settings, "DENORM_FLUSH_AFTER_REQUEST")
    and settings.DENORM_FLUSH_AFTER_REQUEST
):
